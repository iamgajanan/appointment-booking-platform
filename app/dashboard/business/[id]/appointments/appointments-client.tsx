  ...
  return (
    <main className="min-h-screen bg-[#f7f8f5] text-[#18221d]">
      ...
      <section className="mx-auto max-w-7xl px-6 py-10 lg:px-10">
        <div className="mb-8"><p className="mb-2 text-xs font-bold uppercase tracking-[0.2em] text-[#719075]">Appointment management</p><h1 className="text-4xl font-semibold tracking-[-1.5px]">{business.name}</h1><p className="mt-2 text-sm text-[#7d8b80]">View and manage your customer bookings.</p></div>
